...
|**4**|We gaan nu de website aanmaken.<br>[1]Geef de website een naam.<br>[2]Selecteer de Application Pool die we in STAP 2 hebben aangemaakt.<br>[3]Geef het pad aan waar de instantie staat. (Je kan een instantie kopieren, pas de FS-INTRO.dbf aan)<br>[4]Binding instellen op https.<br>[5]Host name invullen met de gewenste 'vriendelijke' URL. Een binding kan je aanvragen bij Arjan van Rijn.<br>[6]Koppel vervolgens een certificaat.</br><details><summary><b>Klik hier voor voorbeeld</b></summary><img src=".Handleiding/image3.png" height="400px"></details>|
